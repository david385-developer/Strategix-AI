        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-2 rounded-lg p-1 pr-2 transition-colors hover:bg-muted">
              ...
              <div className="hidden text-left sm:block">
                <p className="text-sm font-medium leading-tight text-foreground">{user?.name || "Sarah Chen"}</p>
                <p className="text-xs leading-tight text-muted-foreground">{activeWorkspace?.name || "Strategix HQ"}</p>
              </div>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel className="flex items-center gap-2 normal-case">
              ...
              <div>
                <p className="text-sm font-medium text-foreground">{user?.name || "Sarah Chen"}</p>
                <p className="text-xs font-normal text-muted-foreground">{user?.email || "sarah@strategix.io"}</p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
