          ...
          >
            ...
            <Card className="border-primary/20 bg-gradient-to-b from-primary/[0.03] to-transparent">
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={generate} disabled={!objective.trim()} size="lg" className="w-full">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => { toast.success("Campaign created", "Your campaign has been saved as a draft."); navigate("/app/campaigns"); }}
                >
        ...
        {phase === "result" && (
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                { icon: Target, title: "Campaign Strategy", color: "bg-primary/10 text-primary", points: ["3-phase rollout: Teaser → Launch → Sustain", "Focus on product differentiation and social proof", "Mix of organic and paid distribution"] },
                { icon: Users, title: "Target Audience", color: "bg-chart-2/10 text-chart-2", points: ["Marketing managers, B2B SaaS (50-500 emp)", "Secondary: startup founders seeking growth", "Pain point: fragmented marketing tools"] },
                { icon: Filter, title: "Marketing Funnel", color: "bg-chart-4/10 text-chart-4", points: ["Awareness: Reels + ads + influencer", "Consideration: demos + comparison blog", "Decision: free trial + email sequence"] },
                { icon: CalendarDays, title: "Posting Schedule", color: "bg-warning/10 text-warning", points: ["Instagram: 3x/week (Tue, Thu, Sun)", "Email: Bi-weekly nurture sequence", "Blog: 1 pillar post per week"] },
                { icon: DollarSign, title: "Budget Suggestions", color: "bg-success/10 text-success", points: ["45% paid social ads", "30% content production", "15% influencer partnerships", "10% tools & automation"] },
                { icon: TrendingUp, title: "KPIs & Targets", color: "bg-chart-5/10 text-chart-5", points: ["5,000 signups in 90 days", "500K total reach", "8% engagement rate", "$2.40 cost per acquisition"] },
              ].map((s, i) => (
            ...
            <Card>
              ...
              <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                {["Product Storytelling", "Customer Success", "Behind the Scenes", "Educational Tips", "Industry Trends"].map((p, i) => (
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
              ...
              <Button variant="outline" onClick={() => setPhase("generating")}>
                <Sparkles className="h-4 w-4" /> Regenerate
              </Button>
              <Button onClick={() => { toast.success("Campaign created!", "Your campaign is now active."); navigate("/app/campaigns"); }}>
